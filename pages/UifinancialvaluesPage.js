const UI_FINANCIAL_FIELDS = [
  ...
  { key: 'FullyLoadedGrossProfitPercent', fieldName: 'Gross Margin (%)',          occurrence: 1 },
  { key: 'reportedGrossProfit',           fieldName: 'Reported Gross Profit',     occurrence: 1 },
  // { key: 'ReportedDirectGrossProfitPercent', fieldName: '...', occurrence: 1 },
  // ^ uncomment and add correct UI fieldName if UI displays this percentage
